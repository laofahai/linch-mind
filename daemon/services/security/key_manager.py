...
class KeyManager:
    ...
    def _derive_key_from_password(self, password: str, salt: bytes, iterations: int) -> str:
        """使用PBKDF2从密码派生密钥"""
        kdf = PBKDF2HMAC(
    ...
    def rotate_keys(self, old_password: str, new_password: str) -> Optional[DatabaseKeys]:
        """
        密钥轮换 - 使用新密码重新生成密钥
    ...
    def get_security_info(self) -> dict:
        ...
        return {
            ...
            "security_level": "High" if key_params and key_params[1] >= self.MIN_ITERATIONS else "Standard"
        }