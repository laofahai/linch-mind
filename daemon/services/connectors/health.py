...
class ConnectorHealthChecker:
    ...
    def __init__(self, runtime_manager):
        ...
        logger.info(f"ConnectorHealthChecker初始化 - 检查间隔: {self.health_check_interval}秒")
        ...
        try:
            ...
            try:
                ...
                if not psutil_process.is_running():
                    logger.warning(f"🔍 健康检查发现连接器 {connector_id} PID {pid} 已退出")
    ...
    def get_health_stats(self) -> dict:
        ...
        return {
            ...
            "monitoring_active": self._health_monitor_task and not self._health_monitor_task.done()
        }
