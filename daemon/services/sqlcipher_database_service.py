...
from models.database_models import Base, EntityMetadata, UserBehavior, EntityRelationship, AIConversation
...
class SQLCipherDatabaseService:
    ...
    def _configure_sqlcipher(self):
        ...
        with self.engine.connect() as conn:
            ...
            conn.execute(text("PRAGMA cipher_memory_security = ON"))  # 防止内存中密钥泄露
    ...
    def get_database_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "total_records": entity_count + relationship_count + behavior_count + conversation_count,
                "encrypted": True,
                "cipher": "AES-256-GCM"
            }
...
def initialize_sqlcipher_service(db_path: str, master_password: str) -> SQLCipherDatabaseService:
    """初始化SQLCipher服务"""
