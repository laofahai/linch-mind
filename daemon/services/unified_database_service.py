    ...
    def _initialize_service(self, db_path: Optional[str] = None):
        ...
        try:
            ...
            if should_encrypt:
                ...
                if encryption_key:
                    self._service = EncryptedDatabaseService(encryption_key=encryption_key)
...
def create_encrypted_database_service(encryption_key: Optional[str] = None) -> UnifiedDatabaseService:
    """强制创建加密数据库服务实例"""
