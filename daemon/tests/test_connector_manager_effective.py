...
'''
    ...
    @pytest.mark.asyncio
    async def test_real_connector_discovery(self, connector_manager_with_real_db, temp_connector_dir):
        """测试真实的连接器发现功能"""
    ...
    @pytest.mark.asyncio
    async def test_connector_registration_with_real_database(self, connector_manager_with_real_db):
        """测试连接器注册到真实数据库"""
        manager = connector_manager_with_real_db
    ...
    @pytest.mark.asyncio
    async def test_connector_lifecycle_integration(self, connector_manager_with_real_db, temp_connector_dir):
        """测试连接器完整生命周期集成"""
        manager = connector_manager_with_real_db
    ...
    @pytest.mark.asyncio
    async def test_error_handling_invalid_connector(self, connector_manager_with_real_db):
        """测试错误处理 - 无效连接器操作"""
        manager = connector_manager_with_real_db
    ...
    @pytest.mark.asyncio
    async def test_concurrent_connector_operations(self, connector_manager_with_real_db):
        """测试并发连接器操作的安全性"""
        manager = connector_manager_with_real_db
    ...
    @pytest.mark.asyncio 
    async def test_real_process_management(self, connector_manager_with_real_db, temp_connector_dir):
        """测试真实的进程管理（如果支持的话）"""
        manager = connector_manager_with_real_db
