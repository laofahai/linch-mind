...
class StandardLogger:
    ...
    def log_config_change(self, operation: str, target: str, old_value: Any = None, new_value: Any = None):
        """记录配置变更"""
...
def validate_required_field(field_name: str, value: Any, field_type: Type = None) -> Any:
    """验证必需字段"""
